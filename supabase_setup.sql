...
-- 8. Usuario supervisor inicial (contraseña: super2024)
-- Usuario admin inicial     (contraseña: admin2024)
-- CAMBIA ESTAS CONTRASEÑAS DESDE LA APP DESPUÉS DE CONFIGURAR
INSERT INTO cartera_usuarios (usuario, password_hash, rol) VALUES
  ('1045748984', 'avitola02', 'supervisor'),
  ('1047035857', 'svitola30', 'admin')
